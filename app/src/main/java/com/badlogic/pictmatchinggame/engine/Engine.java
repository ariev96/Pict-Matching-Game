package com.badlogic.pictmatchinggame.engine;
...
import com.badlogic.pictmatchinggame.events.EventObserverAdapter;
...
import com.badlogic.pictmatchinggame.model.BoardArrangment;
import com.badlogic.pictmatchinggame.model.BoardConfiguration;
import com.badlogic.pictmatchinggame.model.Game;
...
import com.badlogic.pictmatchinggame.utils.Clock;
...
public class Engine extends EventObserverAdapter {
	...
	public void onEvent(BackGameEvent event) {
		...
		//Shared.eventBus.notify(new GameWonEvent(event.gameState), 1200);
