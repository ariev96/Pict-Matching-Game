...
import com.badlogic.pictmatchinggame.ui.BoardView;
import com.badlogic.pictmatchinggame.ui.PopupManager;
import com.badlogic.pictmatchinggame.utils.Clock;
import com.badlogic.pictmatchinggame.utils.Clock.OnTimerCount;
...
public class GameFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Shared.eventBus.listen(PauseGameEvent.TYPE, this);
	...
	private void setTime(int time) {
		...
		//merubah warna timer menjadi merah
		if(min == 00 && sec == 10){

			mTime.setTextColor(Color.parseColor("#FF0000"));
